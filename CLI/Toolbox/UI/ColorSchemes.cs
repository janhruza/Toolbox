...
public static class ColorSchemes
{
    ...
    /// </summary>
    /// <remarks>
    ///     The array contains color codes for red, orange, yellow, green, blue, and violet, in that
    ///     order. These codes can be used to style console output with vibrant colors in environments that support ANSI
    ///     escape sequences.
    /// </remarks>
    public static string[] Rainbow => new[]
    {
        "\u001b[38;5;196m", // Červená
        "\u001b[38;5;202m", // Oranžová
        "\u001b[38;5;226m", // Žlutá
    ...
    /// </summary>
    /// <remarks>
    ///     The array includes escape codes for light blue, turquoise, light green, light yellow, pink,
    ///     and lavender colors. These codes can be used to format text in terminals that support 256-color ANSI sequences.
    ///     The order of colors in the array corresponds to their intended visual grouping.
    /// </remarks>
    public static string[] Pastel => new[]
    {
    ...
    /// </summary>
    /// <remarks>
    ///     The array includes escape codes for bright blue, neon purple, bright yellow, bright green,
    ///     bright red, and magenta. These codes can be used to style console text with vibrant colors on terminals that
    ///     support 256-color ANSI sequences.
    /// </remarks>
    public static string[] Neon => new[]
    {
        "\u001b[38;5;51m", // Azurová
    ...
    /// </summary>
    /// <remarks>
    ///     The colors included in this set are various shades of gray, blue, green, and brown, chosen to
    ///     provide a subtle and refined appearance in console applications. These escape codes can be used to format text
    ///     output with consistent styling across supported terminals.
    /// </remarks>
    public static string[] Elegant => new[]
    {
    ...
    /// </summary>
    /// <remarks>
    ///     The array includes colors ranging from fiery red and orange to icy blue shades. These escape
    ///     codes can be used to style text in terminals that support 256-color ANSI sequences.
    /// </remarks>
    public static string[] FireIce => new[]
    {
    ...
    /// </summary>
    /// <remarks>
    ///     The array provides a sequence of green shades, ranging from dark to bright, suitable for
    ///     creating fade effects in terminal applications. The escape codes use 256-color mode and are intended for
    ///     environments that support ANSI color sequences.
    /// </remarks>
    public static string[] GreenFade => new[]
    {
    ...
    /// </summary>
    /// <remarks>
    ///     The array provides a sequence of blue shades, ranging from dark blue to lighter azure tones.
    ///     These codes can be used to style console text with varying blue colors, typically for visual effects or
    ///     highlighting.
    /// </remarks>
    public static string[] BlueFade => new[]
    {
    ...
    /// </summary>
    /// <remarks>
    ///     The array provides color codes ranging from dark red to orange-red, suitable for creating
    ///     fade effects in text-based applications. The codes are intended for use in environments that support 256-color
    ///     ANSI escape sequences, such as modern terminals.
    /// </remarks>
    public static string[] RedFade => new[]
    {
    ...
    /// </summary>
    /// <remarks>
    ///     The array contains color codes ranging from dark purple to neon purple, suitable for creating
    ///     fade effects in console applications. The codes use 256-color ANSI sequences and can be combined to style text
    ///     output with a purple gradient.
    /// </remarks>
    public static string[] PurpleFade => new[]
    {
    ...
    /// </summary>
    /// <remarks>
    ///     The array can be used to apply varying shades of gray to console text output, enabling visual
    ///     effects such as fading or highlighting. The escape codes are ordered from the darkest shade to the
    ///     lightest.
    /// </remarks>
    public static string[] GrayFade => new[]
    {
    ...
    /// </summary>
    /// <remarks>
    ///     The array contains color codes that transition from dark purple to yellow, suitable for
    ///     creating visually appealing text effects in console applications that support ANSI colors.
    /// </remarks>
    public static string[] SunsetFade => new[]
    {
        "\u001b[38;5;55m", // tmavě fialová
        "\u001b[38;5;91m", // purpurová
        "\u001b[38;5;127m", // růžová
