...
public static class Resources
{
    ...
    /// </summary>
    public const string URL_EXCHANGE_RATES =
    ...
    /// </summary>
    /// <remarks>
    ///     The URL contains placeholders for day, month, and year, which must be replaced with the
    ///     desired date values in the format specified by the Czech National Bank. The resulting URL can be used to
    ///     download daily exchange rate data for a specific date.
    /// </remarks>
    public const string URL_EXCHANGE_RATES_HISTORICAL =
        "https://www.cnb.cz/cs/financni-trhy/devizovy-trh/kurzy-devizoveho-trhu/kurzy-devizoveho-trhu/denni_kurz.txt?date={day}.{month}.{year}";
    ...
    /// </summary>
    /// <remarks>
    ///     Versioning: <see cref="System.Version.Major" />: Year of release, <see cref="System.Version.Minor" />: Month of
    ///     release,
    ///     <see cref="System.Version.Build" />: Day of release, <see cref="Version.Revision" />: Not used (0).
    /// </remarks>
    public static Version Version => new(major: 2025, minor: 10, build: 11);
}