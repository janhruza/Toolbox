...
public struct Transaction
{
    ...
    /// <param name="amount">
    ///     Transaction amount. It gets automatically converted to its absolute value using the
    ///     <see cref="decimal.Abs(decimal)" /> method.
    /// </param>
    ...
    public Transaction(DateTime date, string description, decimal amount, string category, TransactionType type)
    {
        ...
        this.Amount = decimal.Abs(value: amount);
