...
public interface IConfig
{
    ...
    /// </summary>
    /// <remarks>Specify a valid style name to customize the appearance of accent highlights. The value should
    /// correspond to a style defined in the application's resources or theme.</remarks>
